...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve multiple Tables' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], TableController.prototype, "getMany", null);
__decorate([
    (0, crud_1.Override)('getOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve a single Table' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], TableController.prototype, "get", null);
__decorate([
    (0, crud_1.Override)('createOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Create a single Table' }),
    (0, swagger_1.ApiBody)({
        type: Table_dto_1.TableCreate,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Table_dto_1.Table]),
    __metadata("design:returntype", void 0)
], TableController.prototype, "create", null);
__decorate([
    (0, crud_1.Override)('createManyBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Create multipleTables' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __param(1, (0, crud_1.ParsedBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], TableController.prototype, "createMany", null);
__decorate([
    (0, crud_1.Override)('updateOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a single Table' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __param(1, (0, crud_1.ParsedBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Table_dto_1.Table]),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Replace a single Table' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __param(1, (0, crud_1.ParsedBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Table_dto_1.Table]),
    __metadata("design:returntype", void 0)
], TableController.prototype, "replace", null);
__decorate([
    (0, crud_1.Override)('deleteOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a single Table' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
exports.TableController = TableController = __decorate([
    (0, crud_1.Crud)({
        model: {
            type: Table_dto_1.Table
        },
        dto: {
            create: Table_dto_1.TableCreate,
            update: Table_dto_1.Table,
            replace: Table_dto_1.Table,
        },
        query: {
            limit: 5,
            alwaysPaginate: true,
            join: {
                orders: { eager: false },
                "orders.menu": { eager: false },
                "orders.table": { eager: false },
                "orders.payment": { eager: false },
            },
        }
    }),
